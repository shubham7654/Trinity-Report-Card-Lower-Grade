   ...
   <head>
      ...
      <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
         ...
         * {
         ...
         .child-strengths, .child-development {
         padding: 0 40px;}
         #strengths h2 {
         font-size: 28px;
         font-weight: bold;
         ...
         .benefit-left ul, .benefit-right ul {
         list-style: none;
         }
         .benefit-left ul li, .benefit-right ul li {
         padding: 20px;
         background: #ffffff;
         ...
         .benefit-left ul li:before, .benefit-right ul li:before {
         content: "";
         position: absolute;
         background: #ec572c;
         width: 180px;
         ...
         .benefit-left ul li:after, .benefit-right ul li:after {
         content: "";
         position: absolute;
         background: #ec572c;
         width: 180px;
   ...
   <body>
      <div class="main" id="customers">
         <section id="first">
            ...
            <div class="first-text">
               ...
               <br>
               <p> <span style="color:#ec572c; font-weight:700;">BeyondSkool and Trinity Assessment</span> session is to measure your child’s communication and vocabulary skills. The assessment provides your child's percentile rank among all the students who have appeared for it.</p>
               <br>
            ...
            <div class="first-text-column">
               <div class="left-column">
                  ...
                  <br>
                  <p>We’re sure we’ll see <span style="color:#ec572c; font-weight:700;"><?php echo $studentName;?></span> make you proud and become a true leader! You can find the detailed report card curated by top educationists from NYU and Teach for India attached to this email.</p>
               </div>
         ...
         <section id="skills">
            <h2>Communication Skills Report</h2>
      ...
      <section id="strengths">
         ...
         <div class="child-development">
            <h2>Your child’s area of development</h2>
            <ul>
         ...
         <div class="program-benefits">
            <div class="benefit-left">
               <ul>
                  ...
                  <li>Be Ready for Higher-Education</li>
                  <li>Increases vocabulary up to 4000 words across 3 levels</li>
                  <li>Increases UCAS and credit scores for university applications</li>
               </ul>
            </div>
